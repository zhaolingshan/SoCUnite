import 'package:SoCUniteTwo/screens/comments_report/report_expcomment.dart';
            ...
            children: <Widget>[
              Padding( 
                    ...
                    Row(children: <Widget>[
                      ...
                      SizedBox(width: 10,),
                      FutureBuilder( 
                future: Firestore.instance.collection('users').document(widget.experience.ownerid).get(),
                          ...
                          if (snapshot.data == comment['ownerid']) {
                            return  IconButton(
                              ...
                              onPressed: () async {
                                //final uid = await Provider.of(context).auth.getCurrentUID();
                                await Firestore.instance.collection('public').document('internship_experiences')
                                .collection('Experiences').document(widget.experience.documentid).
                ...
                builder: (context, snapshot) {
                  if (snapshot.data != null) {
                    ...
                    children: <Widget>[
                      ...
                      onPressed: () { //report post
                        Navigator.push(context, 
              MaterialPageRoute(builder: (context) => ReportExperienceComment(post: widget.experience, comment: commentPosted,)));
                      },),
