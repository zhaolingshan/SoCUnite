...
class CollaborationComment extends StatefulWidget {
  final Comments comment;
  final Collaboration post; //needs to have document id 
  CollaborationComment({Key key, @required this.comment, @required this.post}) : super(key: key);

  @override
  _CollaborationCommentState createState() => _CollaborationCommentState();
}

class _CollaborationCommentState extends State<CollaborationComment> {
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    final DocumentReference documentReference = 
                      ...
                      .collection('Collaborations').document(widget.post.documentid)
