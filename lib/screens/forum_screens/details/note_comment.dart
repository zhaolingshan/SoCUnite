...
class NoteComment extends StatefulWidget {
  ...
  final PostNotes post; //needs to have document id 
  NoteComment({Key key, @required this.comment, @required this.post}) : super(key: key);

  @override
  _NoteCommentState createState() => _NoteCommentState();
}
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    final DocumentReference documentReference = 
                      ...
                      .collection('Notes').document(widget.post.documentid)
