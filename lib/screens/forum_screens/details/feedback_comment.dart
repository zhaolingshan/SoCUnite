...
class FeedbackComment extends StatefulWidget {
  ...
  final PostFeedback post; //needs to have document id 
  FeedbackComment({Key key, @required this.comment, @required this.post}) : super(key: key);

  @override
  _FeedbackCommentState createState() => _FeedbackCommentState();
}
...
class _FeedbackCommentState extends State<FeedbackComment> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Post a comment", style: TextStyle(color: Colors.grey[100]),),
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    final DocumentReference documentReference =
                      ...
                      .collection('Feedbacks').document(widget.post.documentid)
