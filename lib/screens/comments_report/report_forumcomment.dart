...
class ReportForumComment extends StatefulWidget {
  final Post post; //forum
  final Comments comment;

  ReportForumComment({Key key, @required this.post, @required this.comment}) : super(key: key);
  @override
  _ReportForumCommentState createState() => _ReportForumCommentState();
}

class _ReportForumCommentState extends State<ReportForumComment> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          child:
          Text(
            "Why are you reporting this comment under 'Forums'?",
          ...
          ListTile(
              ...
              final uid = await Provider.of(context).auth.getCurrentUID();
                ...
                collection('Forums').document(widget.post.documentid).collection('comments').document(widget.comment.documentid).get();
