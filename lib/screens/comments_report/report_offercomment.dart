...
class ReportOffersComment extends StatefulWidget {
  final Offer post; //forum
  final Comments comment;

  ReportOffersComment({Key key, @required this.post, @required this.comment}) : super(key: key);
  @override
  _ReportOffersCommentState createState() => _ReportOffersCommentState();
}

class _ReportOffersCommentState extends State<ReportOffersComment> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          child:
          Text(
            "Why are you reporting this comment under 'Internship offers'?",
          ...
          ListTile(
              ...
              final uid = await Provider.of(context).auth.getCurrentUID();
                ...
                collection('Offers').document(widget.post.documentid).collection('comments').document(widget.comment.documentid).get();
