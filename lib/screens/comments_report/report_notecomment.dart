...
class ReportNoteComment extends StatefulWidget {
  final PostNotes post; //forum
  final Comments comment;

  ReportNoteComment({Key key, @required this.post, @required this.comment}) : super(key: key);
  @override
  _ReportNoteCommentState createState() => _ReportNoteCommentState();
}

class _ReportNoteCommentState extends State<ReportNoteComment> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          child:
          Text(
            "Why are you reporting this comment under 'Notes'?",
          ...
          ListTile(
              ...
              final uid = await Provider.of(context).auth.getCurrentUID();
                ...
                collection('Notes').document(widget.post.documentid).collection('comments').document(widget.comment.documentid).get();
