...
class ReportFeedbackComment extends StatefulWidget {
  final PostFeedback post; //forum
  final Comments comment;

  ReportFeedbackComment({Key key, @required this.post, @required this.comment}) : super(key: key);
  @override
  _ReportFeedbackCommentState createState() => _ReportFeedbackCommentState();
}

class _ReportFeedbackCommentState extends State<ReportFeedbackComment> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          child:
          Text(
            "Why are you reporting this comment under 'Feedbacks'?",
          ...
          ListTile(
              ...
              final uid = await Provider.of(context).auth.getCurrentUID();
                ...
                collection('Feedbacks').document(widget.post.documentid).collection('comments').document(widget.comment.documentid).get();
