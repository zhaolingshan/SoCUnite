...
class ReportExperienceComment extends StatefulWidget {
  final Experience post; //forum
  final Comments comment;

  ReportExperienceComment({Key key, @required this.post, @required this.comment}) : super(key: key);
  @override
  _ReportExperienceCommentState createState() => _ReportExperienceCommentState();
}

class _ReportExperienceCommentState extends State<ReportExperienceComment> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          child:
          Text(
            "Why are you reporting this comment under 'Internship experiences'?",
          ...
          ListTile(
              ...
              final uid = await Provider.of(context).auth.getCurrentUID();
                ...
                collection('Experiences').document(widget.post.documentid).collection('comments').document(widget.comment.documentid).get();
