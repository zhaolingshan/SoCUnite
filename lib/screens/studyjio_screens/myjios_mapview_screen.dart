...
class MyjiosMapviewScreen extends StatefulWidget {
  ...
  @override
  _MyjiosMapviewScreenState createState() => _MyjiosMapviewScreenState();
}

class _MyjiosMapviewScreenState extends State<MyjiosMapviewScreen> {
