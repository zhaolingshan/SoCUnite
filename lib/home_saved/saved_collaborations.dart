...
class SavedCollaborations extends StatefulWidget {
  @override
  _SavedCollaborationsState createState() => _SavedCollaborationsState();
}

class _SavedCollaborationsState extends State<SavedCollaborations> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Saved Collaborations"),
      ),
      ...
      body: Container(
        child: StreamBuilder(
          ...
          => buildCollaboration(context, snapshot.data.documents[index]),
  ...
  Stream<QuerySnapshot> getUsersCollaborationsPostsSnapshot(BuildContext context) async* {
    ...
    .document(uid).collection('saved_collaborations').snapshots();
  }


  Widget buildCollaboration(BuildContext context, DocumentSnapshot post) {
